  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Toggle annoying warnings for quick exploration
        ...
        map('<leader>td', ToggleDiagnosticsMode, '[T]oggle Inlay [D]iagnostics')
      end,
    })
    ...
    local servers = {
      ...
      -- gopls = {},
      -- pyright = {},
      -- rust_analyzer = {}, -- not needed since rustaceanvim already brings in rust_analyzer
      elixirls = {},
